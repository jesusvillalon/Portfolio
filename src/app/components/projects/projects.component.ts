...
export class ProjectsComponent {
  ...
  public projectsItems = [
    ...
    { language: 'en', title: 'Here you can see my projects:', list: [
      {id: 0, name: 'Clinicalia', img: 'clinicalia.png',
      description: 'Platform for registering physiotherapy clinics, professionals, and patients. We handle registration, login and appointment booking for both professionals and patients, implementing a payment gateway for the appointment.'},
      {id: 1, name: 'Interview-faqs', img: 'interview-faqs.png',
      description: 'Interview Faqs is a platform designed to address the most common theoretical questions in frontend developer job interviews, which are organized into three levels. We have included external links to learn resources for the technical aspects of these interviews'},
